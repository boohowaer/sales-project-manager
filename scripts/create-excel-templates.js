...
function createProjectTemplate() {
  const data = [
    ['项目名称*', '客户名称*', '项目描述', '项目状态', '项目金额', '成功概率', '开始日期', '预期关闭日期', '有开工函', '已签署合同', '归属年份'],
    ...
    ['移动应用开发', '王芳', '开发iOS和Android双平台移动应用', 'won', 80000.00, 100, '2026-03-01', '2026-08-31', 'TRUE', 'TRUE', 2026],
    ['数据分析平台', '赵强', '大数据分析与可视化平台开发', 'lost', '', '', '2026-01-01', '2026-03-31', 'FALSE', 'FALSE', 2026],
    ['年度运维服务', '刘伟', 'IT基础设施运维和技术支持服务', 'on_hold', 30000.00, 50, '2026-01-01', '2026-12-31', 'TRUE', 'FALSE', 2026],
    ['电商平台建设', '孙丽', 'B2C电商平台开发，包含支付和物流集成', 'active', 250000.00, 80, '2026-04-01', '2027-03-31', 'TRUE', 'TRUE', 2026],
  ];
